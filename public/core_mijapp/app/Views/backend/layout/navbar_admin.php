        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <center class="mt-3 mb-3">
                    <a class="btn mb-2 bg-gradient-primary" href="<?= base_url(); ?>/profil/editprofil/<?= $user['id']; ?>" role="button" class="dropdown-item"><i class="fas fa-edit"> Edit Profile</i></a>
                    <div class="dropdown-divider"></div>
                    <a class="btn bg-gradient-danger" href="<?= base_url(); ?>/logout" role="button" class="dropdown-item"><i class="fas fa-users mr-2"> Logout</i></a>
                </center>
...
<aside class="main-sidebar elevation-4 sidebar-light-navy">
    <!-- Brand Logo -->
    <a href="<?= base_url(); ?>/dashboard" class="brand-link navbar-navy">
        ...
        <span class="brand-text font-weight-light" style="color: white;">MIJ</span>
    </a>
